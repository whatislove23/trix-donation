...
export default function CollectionCard(props) {
  ...
  return (
    <Link to={`/collections/${id}`}>
      <div
        className={`flex h-full w-full  flex-col justify-between  gap-2 overflow-hidden  rounded-2xl border-2 border-bg-300 p-4 transition  hover:scale-105 md:max-w-full md:gap-4  lg:max-w-[400px]  lg:gap-5   ${isProfile ? 'rounded-2xl p-2' : ' lg:rounded-[38px] lg:p-7'}`}>
        <div
