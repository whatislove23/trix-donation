            ...
            >
              <SwiperSlide>
                <div className='flex max-w-[514px]  flex-col gap-2 text-white'>
                  <h3 className='text-2xl font-semibold lg:text-4xl'>Волонтер</h3>
                  ...
                  <p className=' text-xl font-medium lg:text-2xl'>
                    Можливість додавати звіти та демонтсрувати скільки зборів було закрито саме
                    волонтером
                  </p>
                </div>
              </SwiperSlide>
              <SwiperSlide>
                <div className='flex max-w-[514px]  flex-col gap-2 text-white'>
                  ...
                  <p className=' text-xl font-medium lg:text-2xl'>
                    Підвищення прозорості завдяки можливістю додавання звіту до кожного завершеного
                    збору
                  </p>
                </div>
              </SwiperSlide>
